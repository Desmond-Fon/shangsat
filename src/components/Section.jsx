const Section = () => {
    return (<div className="px-[16px] py-[48px] lg:p-[80px] flex justify-center items-center flex-col secBg">
        ...
        <div>
                <a href="#community"><button className='bg-secondary text-[24px] text-white px-[28px] font-[500] rounded-[8px] border-secondary border-[2px] py-[8px] font-poppins shad'>Join The Community</button></a>
        </div>
    </div>);
}
