...
const Footer = () => {
    return (<div className="px-[80px] pt-[45px]">
        <div className="flex justify-between items-start">
            <div>
                <p className="font-roboto text-darkText font-[500] pb-[18px]">CATEGORIES</p>
                <ul className="text-footerLink gap-[18px] flex justify-start items-start flex-col">
            ...
            <div>
                <p className="font-roboto text-darkText font-[500] pb-[18px]">PRODUCT</p>
                <ul className="text-footerLink gap-[18px] flex justify-start items-start flex-col">
            ...
            <div>
                <p className="font-roboto text-darkText font-[500] pb-[18px]">SOLUTIONS</p>
                <ul className="text-footerLink gap-[18px] flex justify-start items-start flex-col">
            ...
            <div>
                <p className="font-roboto text-darkText font-[500] pb-[18px]">RESOURCES</p>
                <ul className="text-footerLink gap-[18px] flex justify-start items-start flex-col">
        ...
        <div className="flex justify-between items-center py-[24px] font-roboto text-footerLink">
