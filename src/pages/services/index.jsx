...
const Services = () => {
    return (<>
        <div className="p-[16px] py-[38px] lg:p-[80px] lg:pb-0">
            <h1 className='font-anton text-darkText text-[32px] lg:text-[50px] leading-[35px] lg:leading-[60px] text-center'>Our Services</h1>
        ...
        <div className='w-[100%]'>
            ...
            <div className='background2 h-[450px] lg:h-[420px]'>
                <div className='px-[16px] py-[38px] lg:p-[80px] flex h-full justify-between items-center text-center lg:text-left lg:items-end flex-col'>
                    <div>
                    ...
                    <p className='text-white text-center lg:text-end font-poppins text-[16px] lg:text-[18px]'>Harnessing the power of the sun, our solar water heaters provide you energy-efficient, eco-friendly, and endless hot water. We believe in the power of sustainable living, and our solar solutions are a testament to that commitment. Research has proven that electricity is a part of nature and our power generating devices are nature friendly. With Shangsat power, eco-friendly energy is sure.</p>
                    <div>
                        <Link to={'/gallery'}>
            ...
            <div className='background4 h-[450px] lg:h-[420px]'>
                <div className='px-[16px] py-[38px] lg:p-[80px] flex h-full justify-between items-center text-center lg:text-left lg:items-end flex-col'>
                    <div>
